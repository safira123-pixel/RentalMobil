...
<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modal1">Join Us</button>
        ...
        <div class="modal-dialog" role="document">
            ...
            <div class="modal-header">
                <h5 class="modal-title" id="modal1Title" style="color:#222">Caution</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <h7 style="color:#222"> You're already Registered </h7>
            </div>
...
<div class="widget no-box">
<h5 class="widget-title">Our Contact<span></span></h5>
...
<p>Copyright Need-A-Car © 2022. All rights reserved.</p>
</div>
</div>
</div>
</div>
